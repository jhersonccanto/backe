...
public class RolAccesoServiceImpl implements RolAccesoService {
	...
	@Autowired
	private RolAccesoRepository rolaccesodao;
	
	@Override
	public RolAcceso create(RolAcceso a) {
		// TODO Auto-generated method stub
		return rolaccesodao.save(a);
	}
	...
	public void delete(Long id) {
		// TODO Auto-generated method stub
		rolaccesodao.deleteById(id);
	}

	@Override
	public Optional<RolAcceso> read(Long id) {
		// TODO Auto-generated method stub
		return rolaccesodao.findById(id);
	}

	@Override
	public List<RolAcceso> readAll() {
		// TODO Auto-generated method stub
		return rolaccesodao.findAll();
	}
